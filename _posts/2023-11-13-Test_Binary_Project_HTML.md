...
comments: true
layout: post
title: Test for the Binary Project HTML Test
...
<body>
    ...
    <script src="{{site_baseurl}}/_notebooks/JS_Scripts/2023-11-13-Random_Image_Binary_Project.js"></script> <!-- should be working -->
    <script src="{{site_baseurl}}/_notebooks/JS_Scripts/2023-11-13-Check_Quiz_Binary_Project.js"></script>
</body>
</html>
