...
<html>
    ...
    <body>
        ...
        <a href="http://127.0.0.1:4100/WRONG/leaderboard"><button class="leaderboardButton" type="button">Leaderboard</button></a>
        <a href="http://127.0.0.1:4100/WRONG/login"><button class="loginButton" type="button">Login</button></a>
    </body>
</html>
